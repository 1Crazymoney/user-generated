	...
	grunt.initConfig({
		...
		combine: {
			single: {
				...
				output: "./bitcoincashnotes.com.html",
				tokens: [
					...
					{ token: "//ninja.images.js", file: "./src/ninja.images.js" },
					{ token: "//ninja.imagesdenominations.js", file: "./src/ninja.imagesdenominations.js" },
		...
		lineending: {               // Task
			dist: {                   // Target
				...
				files: {                // Files to process
					'./bitcoincashnotes.com.html': ['./bitcoincashnotes.com.html']
				}
			}
		}
	});
